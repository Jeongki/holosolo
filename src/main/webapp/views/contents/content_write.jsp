...
<!-- action 부분에서 반드시 경로 확인 후, Controller로 보낼 것. -->
	<div align="center" style="margin-top: 100px;">
		<form action="/holosolo/content.do" method="post" name="write_form" enctype="multipart/form-data">
			...
			<textarea name="content" id="content" rows="10" cols="100" style="height: 412px; width: 100%"></textarea>
			<script type="text/javascript">
				var oEditors = [];
