	...
	<div id="carousel-example-generic" class="carousel slide" data-ride="carousel" style="margin-top: 6%;">
		...
		<div class="carousel-inner" role="listbox">
			<div class="item active">
				<img src="img/1인노래방.jpg" style="width: 100%; height: 50%;" />
				<div class="carousel-caption">
					<h3>솔로의</h3>
					<p>솔직담백한 모든 세상살이 이야기</p>
				</div>
			</div>
			<div class="item">
				<img src="img/1인식당.jpg" style="width: 100%; height: 50%;" />
				<div class="carousel-caption">
					<h3>솔로을 위한</h3>
					<p>생활 정보 꿀팁 이야기들</p>
				</div>
			...
			<div class="item">
				<img src="img/1인취지.jpg" style="width: 100%; height: 50%;" />
				<div class="carousel-caption">
					<h3>솔로들에 의한</h3>
					<p>솔로들이 만들어 가는 이야기</p>
				</div>
			...
			<div class="container-fluid">
				...
				<div class="container" align="center" style="margin-bottom: 10px;">
					...
					<div class="col-xs-6" style="width:48%; margin-right: 2%;  border:2px solid; border-color: rgba(153, 154, 154, 0.09); border-radius: 24px;">
						...
						<div align="center" class="thumbs col-md-5 " style="margin-top: 2%; width: 100%;">
					...
					<!-- group -->
					<div class="col-xs-6"
						style="width: 48%; margin-left: 2%; border: 2px solid; border-color: rgba(153, 154, 154, 0.09); border-radius: 24px;">
						<h2 align="center" style="margin-bottom: 8%;">
							<b>함께하는</b>
						</h2>
						<c:forEach var="gdto" items="${requestScope.groupList}" begin="0"
							...
							<div align="middle" class="thumbs col-md-5"
								id="groupform"
								style="margin-top: 1%; width: 100%; margin-bottom: 1%;">
								<div style="padding: 5px; height: 156px;">
									...
									<div class="col-xs-4" style="width: 60%;">
										<div style="width: 100%; margin-top: 3%;" align="left">
