					...
					<div id="head" style="height: 65px;">
						<nav class="navbar navbar-default navbar-fixed-top">
							<div class="container-fluid"
								...
								<div id="center" style="padding-left: 37%;">
									<ul class="nav navbar-nav" style="width: 400px; height: 50px; margin-top: 1.5%;">
												...
												<tr>
													<td>
														<a title="content" href="/holosolo/content.do?command=contentList&&category=seeAll"
														   ...
														   <img src='/holosolo/img/content.png' style="width: 60px; height: 50px;"></a>
													</td>
												</tr>
												<tr>
													<td align="center"><span><b>내게맞는</b></span></td>
												</tr>
											</table>
										</li>
										<li style="margin-right: 10%;">
												...
												<tr>
													<td>
														<a title="shareTip" href="/holosolo/share.do?command=shareList&&category=seeAll"
															style="padding-bottom: 0px;">
															<img src='/holosolo/img/sharetip.png' style="width: 60px; height: 50px;"></a>
													</td>
												</tr>
												<tr>
													<td align="center"><span><b>너를위한</b></span></td>
												</tr>
											</table>
										</li>
										<li style="margin-right: 10%;">
												...
												<tr>
													<td>
														<a title="group" href="/holosolo/group.do?command=groupList&&category=seeAll"
															style="padding-bottom: 0px;">
															<img src='/holosolo/img/group.png' style="width: 60px; height: 50px;"></a>
													</td>
												</tr>
												<tr>
													<td align="center"><span><b>함께하는</b></span></td>
												</tr>
											</table>
										</li>
										<li>
											<table>
												<tr>
													<td>
														<a title="group" href="/holosolo/main.do?command=introduce" style="padding-bottom: 0px;">
															<img src='/holosolo/img/introduce.png' style="width: 60px; height: 50px;"></a>
													</td>
												</tr>
												<tr>
													<td align="center"><span><b>Story</b></span></td>
												</tr>
											</table>
										</li>
									</ul>
				...
				<div class="modal fade" role="dialog" id="myModal3" tabindex="-1"
					...
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title" id="gridSystemModalLabel">MyPage</h4>
						</div>
						<div class="modal-body"
								...
								<div class="col-md-2" style="width: 20%; height: 400px; border-right:1px dotted lightgrey;">
									<div class="row" align="center">
										...
										<input class="btn btn-default" type="button" id="photoBtn"
											value="사진 변경" style="margin-top: 7px"><br>
										<script type="text/javascript">
