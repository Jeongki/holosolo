				...
				<table align="center" style="margin-left: 10px; margin-right: 10px;">
					<tr>
						<table width="650px"
							...
							<tr>
								<td style="padding: 20px 30px 0px;">
									<p>
									<div style="border: 0px; background-color: white; margin:10px;">${ groupDTO.content }</div>
								</td>
							</tr>
							
							<tr>
								<td valign="middle" style="padding: 0px 30px 30px 30px;">
									<div id="btn">
										<a href="/holosolo/group.do?command=groupList&&category=seeAll" 
											class="btn btn-xs btn-default">목록</a>
						...
						<form name="commentWrite" style="width: 630px">
							...
							<input type="button" id="commentWrite" class="btn btn-xs btn-default" value="작성" style="margin-top: -6%;"><br><br><br>
						</form>
