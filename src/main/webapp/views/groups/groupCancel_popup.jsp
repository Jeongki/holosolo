...
<body>
	<div id="checkPassword" style="vertical-align: middle;">
		...
		<input class="btn btn-default" type="button" id="checkPassBtn" value="확인" style="width: 58.66px; height: 34.33px; margin-bottom: 4px; ">
		<input class="btn btn-default" type="button" id="cancelBtn" value="취소" style="width: 58.66px; height: 34.33px; margin-bottom: 4px;">
	</div>
</body>
</html>