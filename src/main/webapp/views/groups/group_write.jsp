...
<body>
	<div align="center" style="margin-top: 100px;">
		<form action="/holosolo/group.do" method="post" name="write_form" enctype="multipart/form-data">
				...
				<tr>
					<td colspan="2">
						<input type="text" id="title" maxlength="20" name="title"
							maxlength="50" size="90" required="required" width="450px" class="form-control-title" placeholder="제목을 입력하세요">
					</td>
				</tr>
			</table>
			<p><p>
			...
			<!-- Map 지도!!!! -->
			<!-- <div id="map" style="width: 650px; height: 300px; position: relative; overflow: hidden;margin-left: 14px;"></div> -->
			...
			<table style=" border-image: none; width: 647.82px;">
				<tr>
					<td>
						...
						<input type="button" id="selectBtn" value="장소결정">
					<br>
					</td>
				</tr>
			</table>
